...
public static partial class SubscriberExtension
{
    ...
    /// <returns></returns>
    public static Task ReceiveCommandAsync<T>(
        this ISubscriber subscriber,
        Func<Action<T?>> resolve,
        ushort prefetchCount = 10,
        int retry = 3,
        bool dlx = true) =>
        subscriber.ReceiveAsync(resolve, true, prefetchCount, retry, dlx);
    ...
    public static Task ReceiveCommandAsync<T>(
        ...
        int retry = 3,
        bool dlx = true) =>
        subscriber.ReceiveAsync(topic, resolve, true, prefetchCount, retry, dlx);
    ...
    /// <param name="dlx"></param>
    /// <returns></returns>
    public static Task ReceiveCommandAsync(
        this ISubscriber subscriber,
        string topic,
