...
public partial interface ISubscriber
{
    ...
    /// <param name="prefetchCount"></param>
    /// <typeparam name="T"></typeparam>
    void ListenMessage<T>(string topic, Func<Action<byte[]>> resolve, ushort prefetchCount = 10);
    ...
    /// <param name="prefetchCount"></param>
    /// <typeparam name="T"></typeparam>
    void ListenMessage<T>(string topic, Func<Func<byte[], Task>> resolve, ushort prefetchCount = 10);
}